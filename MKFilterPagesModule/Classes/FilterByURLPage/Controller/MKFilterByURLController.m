...
@interface MKFilterByURLController ()<UITableViewDelegate,
...
@implementation MKFilterByURLController

- (void)dealloc {
    NSLog(@"MKFilterByURLController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKFilterPagesModule", @"MKFilterByURLController", @"mk_filterPages_slotSaveIcon.png") forState:UIControlStateNormal];
