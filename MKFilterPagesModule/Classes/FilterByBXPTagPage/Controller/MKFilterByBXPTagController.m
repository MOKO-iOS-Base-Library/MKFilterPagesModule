...
@interface MKFilterByBXPTagController ()<UITableViewDelegate,
...
@implementation MKFilterByBXPTagController

- (void)dealloc {
    NSLog(@"MKFilterByBXPTagController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKFilterPagesModule", @"MKFilterByBXPTagController", @"mk_filterPages_slotSaveIcon.png") forState:UIControlStateNormal];
