//
//  MKFilterByBXPSensorInfoController.m
...
@interface MKFilterByBXPSensorInfoController ()<UITableViewDelegate,
...
@implementation MKFilterByBXPSensorInfoController

- (void)dealloc {
    NSLog(@"MKFilterByBXPSensorInfoController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKFilterPagesModule", @"MKFilterByBXPSensorInfoController", @"mk_filterPages_slotSaveIcon.png") forState:UIControlStateNormal];
